...
describe('Unit test RadioButton react', function () {
    ...
    test('Render successfully without props', function () {
        var container = render(React.createElement(RadioButton, { name: "Fruit" })).container;
        if (container.firstElementChild) {
            var childEl_1 = container.firstElementChild;
            expect(childEl_1.classList.length).toBe(1);
            expect(['kuc-input-radio'].every(function (c) { return childEl_1.classList.contains(c); })).toBe(true);
    ...
    test('Render successfully with full props', function () {
        ...
        var container = render(React.createElement(RadioButton, { name: "Fruit", items: expectedItems, value: value, isDisabled: true, isVisible: false })).container;
        if (container.firstElementChild) {
            var childEl_2 = container.firstElementChild;
            expect(childEl_2.classList.length).toBe(1);
            expect(['kuc-input-radio'].every(function (c) { return childEl_2.classList.contains(c); })).toBe(true);
    ...
    test('Render successfully with wrong props', function () {
        ...
        // @ts-ignore
        var container = render(React.createElement(RadioButton, { name: "Fruit", items: expectedItems, isVisible: "abc", isDisabled: "abc" })).container;
        if (container.firstElementChild) {
            var childEl_3 = container.firstElementChild;
            expect(childEl_3.classList.length).toBe(1);
            expect(['kuc-input-radio'].every(function (c) { return childEl_3.classList.contains(c); })).toBe(true);
    ...
    test('Render successfully with onChange for not selected', function () {
        ...
        var container = render(React.createElement(RadioButton, { name: "Fruit", items: expectedItems, value: value, onChange: handleChange })).container;
        if (container.firstElementChild) {
    ...
    test('onClick event will not work', function () {
        ...
        // @ts-ignore
        var container = render(React.createElement(RadioButton, { name: "Fruit", items: expectedItems, value: value, onClick: handleClick })).container;
        if (container.firstElementChild) {
            var childEl = container.firstElementChild;
    ...
    test('throw error with invalid option.items', function () {
        expect(function () {
            // @ts-ignore
            render(React.createElement(RadioButton, { name: "Fruit", items: ['orange', 'banana', 'lemon'] }));
        }).toThrowError();
    });
    test('throw error with duplicate option.items[x].value', function () {
        expect(function () {
            ...
            render(React.createElement(RadioButton, { name: "Fruit", items: expectedItems }));
        }).toThrowError();
    });
    test('throw error with invalid prop type of option.value', function () {
        expect(function () {
            ...
            // @ts-ignore
            render(React.createElement(RadioButton, { name: "Fruit", items: expectedItems, value: [expectedValues[0]] }));
        }).toThrowError();
    });
    test('throw error with invalid prop value of option.value', function () {
        expect(function () {
            ...
            render(React.createElement(RadioButton, { name: "Fruit", items: expectedItems, value: expectedValues[2] }));
        }).toThrowError();
    });
});
